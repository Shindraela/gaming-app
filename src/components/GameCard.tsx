...
import { setPlatformLogo, setGameDetailsUrl } from '../shared/utils';
import { GameCardAbout } from './GameCardAbout';
      ...
      <div className="gameCard-content">
        ...
        <div className="gameCard-infos">
          ...
          <div className="gameCardButtons">
            <button
              className="gameCardButton gameCardButton-add gameCardButton--light"
              type="button"
            >
              <span className="SVGInline gameCardButton-icon">
                <svg
                  className="SVGInline-svg gameCardButton-iconSvg"
              ...
              <span className="gameCardButton__inner">755</span>
            </button>

            <button
              className="gameCardButton gameCardButton-wishlist gameCardButton--light"
              type="button"
            >
              <span className="SVGInline gameCardButton-icon">
                <svg
            ...
            <button
              className="gameCardButton gameCardButton-more gameCardButton--light"
              type="button"
            >
              <span className="SVGInline gameCardButton-icon">
                <svg
                ...
                >
                  <path
                    d="M2 6c1.103 0 2 .897 2 2s-.897 2-2 2-2-.897-2-2 .897-2 2-2zm12 0c1.103 0 2 .897 2 2s-.897 2-2 2-2-.897-2-2 .897-2 2-2zM8 6c1.103 0 2 .897 2 2s-.897 2-2 2-2-.897-2-2 .897-2 2-2z"
                    fill="#FFF"
                    fillRule="evenodd"
                  ></path>
                </svg>
